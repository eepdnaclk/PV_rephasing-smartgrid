    ...
    for it = 1:beta
        ...
        for k=1:alpha
            ...
            if Censorship
                ...
                B(end).Position     = [N_data.A(randi(N_data.N_opt_my,1),:), N_data.B(randi(N_data.N_opt_my,1),:), N_data.C(randi(N_data.N_opt_my,1),:), N_data.D(randi(N_data.N_opt_my,1),:), N_data.E(randi(N_data.N_opt_my,1),:), N_data.F(randi(N_data.N_opt_my,1),:), N_data.G(randi(N_data.N_opt_my,1),:)];

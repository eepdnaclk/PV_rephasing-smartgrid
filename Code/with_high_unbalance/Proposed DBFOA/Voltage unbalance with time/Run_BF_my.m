function [ Best ] = Run_BF_my( params, Position, N_data )
...
for l = 1:Ned
    ...
    for k = 1:Nre    
        ...
        for j=1:Nc
            % (4.1) Chemotatic step
            for i=1:S 
				%display(strcat('BF-MY:::ED(l) = ',num2str(l),'|Re(k) = ',num2str(k),' |Che(j) = ',num2str(j),' |Bac(i) = ',num2str(i)));
